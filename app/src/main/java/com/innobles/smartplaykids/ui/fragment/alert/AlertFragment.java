...
import com.innobles.smartplaykids.ui.viewHolder.AlertViewHolder;
 ...
 */
public class AlertFragment extends BaseFragment implements BaseAdapter.BindAdapterListener<AlertViewHolder> {
    ...
    private BaseAdapter<StudInfo, AlertViewHolder> baseAdapter;
    ...
    protected void setUp(View view) {
        ...
        onBackArrowShow();
        setTitleMessage(getString(R.string.alert));
    }
    ...
    public void setData(List<StudInfo> studentInfos) {
        ...
        baseAdapter = new BaseAdapter<>(getActivity(), studentInfos, this, AlertViewHolder.class, R.layout.item_circular);
    ...
    @Override
    public void onBind(AlertViewHolder holder, int position) {
